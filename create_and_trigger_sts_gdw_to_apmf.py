...
STS_JOB_NAME_XCOM_KEY = "created_sts_job_name"
...
def trigger_sts_if_needed(**context):
    if context['ti'].xcom_pull(key="trigger_sts"):
        ...
        job_name = context['ti'].xcom_pull(task_ids='create_sts_job', key='job_name')
        if not job_name:
        ...
        print("No new files — skipping STS trigger.")

with models.DAG(
    dag_id="create_and_trigger_sts_gdw_to_apmf",
