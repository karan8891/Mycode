...
TRANSFER_PREFIX = "new-file-prefix/"
...
with models.DAG(
    dag_id="event_driven_transfer_p1_to_p2",
    start_date=datetime(2023, 1, 1),
    schedule_interval="*/15 * * * *",
    catchup=False,
    tags=["sts", "event-driven", "p1_to_p2"],
) as dag:
    ...
    run_transfer = CloudDataTransferServiceCreateJobOperator(
        ...
        body={
            "description": "Event-driven transfer from P1 Bucket 1 to P2 Bucket 2",
            "status": "ENABLED",
            "projectId": PROJECT_ID,
            "transferSpec": {
                "gcsDataSource": {"bucketName": BUCKET_NAME},
